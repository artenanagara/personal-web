...
function CardPorto() {
  return (
    <div className="bg-sky-500 pt-8 px-8 flex flex-col gap-16 rounded-xl md:flex-row md:pt-16 md:px-16">
        ...
        <div className="flex flex-row gap-8">
          ...
          <div className="flex flex-col justify-between -gap-1 text-white">
            ...
            <p className="text-base md:text-2xl font-medium">
              2019 &bull; UI/UX Design
            </p>
          </div>
        </div>
        <div className="text-gray-200 text-sm md:text-lg">
          <p>
            Hello little cute foodie,We're food delivery expert from South
            Korea. We are here to share the love and passion for food with you
            by delivering yummy dishes to your doorstep.Try it now! (many hot
            deals are saved for new users, don't miss it)
          </p>
        </div>
      ...
      <div className="">
        <img
          className="rounded-t-lg w-[350px] h-[540px] object-center"
          src={baeminscreen}
          alt=""
        />
      </div>
