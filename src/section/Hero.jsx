...
function Hero() {
  return (
    <div className="container mx-auto flex flex-col gap-4 mt-8 md:gap-8">
      ...
      <div>
        <h1 className="text-white font-black text-5xl leading-tight md:text-[80px]">
          Hey, I'm{" "}
          <span className="text-primary">
            Artena Nagara<span className="text-white">.</span>
          </span>
        </h1>
      </div>
      ...
      <div>
        <button className="mt-4 px-4 py-2 bg-primary text-sm  text-dark-0 font-semibold rounded-md md:text-base md:px-6 md:py-4  hover:bg-white hover:text-black">
          See what i do &rarr;
        </button>
      </div>
    </div>
